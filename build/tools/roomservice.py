...
DEBUG = False
default_manifest = ".repo/manifests/cerberus_default.xml"
custom_local_manifest = ".repo/local_manifests/cerberus_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "cerberus.dependencies"
org_manifest = "CERBERUS-Devices"  # leave empty if org is provided in manifest
org_display = "CERBERUS-Devices"  # needed for displaying
