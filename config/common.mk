...
ifdef CERBERUS_BUILD_TYPE
    CERBERUS_BUILD_TYPE := UNOFFICIAL
endif

ifdef CERBERUS_MAINTAINER
    CERBERUS_MAINTAINER= USERNAME
endif

# Set all versions
CERBERUS_VERSION := CerberusOS-1.5_$(CERBERUS_POSTFIX)-$(CERBERUS_BUILD)-$(CERBERUS_BUILDTYPE)
CERBERUS_MOD_VERSION := CerberusOS-1.5_$(CERBERUS_POSTFIX)-$(CERBERUS_BUILD)-$(CERBERUS_BUILDTYPE)
