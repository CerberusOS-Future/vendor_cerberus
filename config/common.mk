...
# Set all versions
CERBERUS_VERSION := CerberusOS-1.6-$(CERBERUS_POSTFIX)-Pie4-$(CERBERUS_BUILD)-$(CERBERUS_BUILD_TYPE)
CERBERUS_MOD_VERSION := CerberusOS-1.6-$(CERBERUS_POSTFIX)-Pie4-$(CERBERUS_BUILD)-$(CERBERUS_BUILD_TYPE)
